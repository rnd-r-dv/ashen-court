...
export function createTestPool(): Card[] {
	const named: Card[] = [
		...
		{
			id: "test-spell-ec",
			name: "Test Spell (Enemy Creature)",
			type: "spell",
			cost: 1,
			keywords: [],
			effects: [{ kind: "dealDamage", value: 1, target: "enemyCreature" }],
			rarity: "common",
			archetype: "neutral",
			art: art(902),
			author: "curated",
		...
		},
		{
			...
			triggers: [
				{
					when: "battlecry",
					effects: [{ kind: "dealDamage", value: 2, target: "allEnemies" }],
				},
			],
			rarity: "common",
			archetype: "neutral",
		...
		},
		{
			...
			triggers: [
				{
					when: "startOfTurn",
					effects: [{ kind: "heal", value: 2, target: "hero" }],
				},
			],
			rarity: "common",
			archetype: "neutral",
