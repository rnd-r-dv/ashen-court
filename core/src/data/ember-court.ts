...
export const CARDS: Card[] = [
  // Commons (11)
  creature('ember-cinderling', 'Cinderling', 1, 2, 1, 'common', [], [], 'A coal given breath and malice. The court breeds its smallest cruelties first.'),
  ...
  creature('ember-ashhunter', 'Ash Hunter', 2, 2, 2, 'common', [], [], 'It stalks the cooled fields where the fires have passed, harvesting whatever survived the burning.'),
  ...
  creature('ember-firebrand', 'Firebrand', 3, 3, 3, 'common', [], [], 'Snatched burning from a dying pyre and given a sword, the firebrand carries the court\'s anger into the line.'),
  ...
  creature('ember-phoenixwhelp', 'Phoenix Whelp', 5, 4, 3, 'rare', ['lifesteal'], [], 'A fledgling of the Sovereign\'s brood, learning that every dying ember is a debt owed to fire.'),
  ...
  creature('ember-ashwing', 'Ashwing', 7, 6, 5, 'epic', ['charge'], [], 'It does not descend to fight. It arrives, and the field remembers it should already be ash.'),
