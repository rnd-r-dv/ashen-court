...
export const CARDS: Card[] = [
  // Commons (11)
  creature('dragon-whelp', 'Dragon Whelp', 1, 1, 2, 'common', ['rush'], [], 'Every dragonflight begins with a single hatchling too proud to stay on the ground.'),
  creature('dragon-scaleglider', 'Scaleglider', 2, 2, 3, 'common', ['stealth'], [], 'It rides the mountain drafts for hours, turning on air that would throw lesser wings from the sky.'),
  ...
  creature('dragon-hatchling', 'Hatchling', 3, 3, 3, 'common', [], [{ when: 'battlecry', effects: [summon('token-dragon-whelp')] }], 'Fresh from the shell, it tests its fire on anything that moves — and most things wisely move.'),
  ...
  creature('dragon-drakeling', 'Drakeling', 5, 5, 5, 'common', [], [{ when: 'battlecry', effects: [buff(1, 1, 'friendlyDragon')] }], "Too young to join the flight's hunt, too proud to admit it."),
  // Rares (5)
  ...
  creature('dragon-warden', 'Warden of Skies', 6, 5, 6, 'rare', ['taunt'], [], 'The Warden patrols the cloud-road day and night, and the storm itself steps aside.'),
  creature('dragon-prince', 'Prince of Scales', 7, 7, 7, 'rare', [], [{ when: 'battlecry', effects: [buff(2, 2, 'friendlyDragon')] }], 'Heir to the hoard and to the mountain that guards it, he has never known doubt.'),
  // Epics (3)
  ...
  creature('dragon-tyrant', 'Wyrm Tyrant', 8, 8, 6, 'epic', ['windfury'], [], "Its hoard is a mountain range, and its temper is the earthquake that shapes it."),
  // Legendaries (2)
