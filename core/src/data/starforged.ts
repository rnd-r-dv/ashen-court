...
export const CARDS: Card[] = [
  ...
  creature('star-acolyte', 'Star Acolyte', 2, 2, 3, 'common', [], [], 'Newest to the Archon\'s choir, they read destinies in the ash of dying stars.'),
  ...
  creature('star-sentinel', 'Sentinel', 4, 3, 5, 'common', [], [], 'It has watched the void since before the first spark was struck — and it watches still.'),
  ...
  creature('star-mage', 'Starmage', 5, 4, 5, 'common', [], [], 'Mages of the starforged court weave the sky\'s light into armor and blade alike.'),
  ...
  creature('star-giant', 'Star Giant', 7, 7, 7, 'rare', [], [], 'A titan born of coalesced starlight; the sky dims where it walks.'),
  spell('star-eclipse', 'Eclipse', 7, 'rare', [dmg(7, 'any')], 'Stellara draws a veil across the sun, and the world reels in the sudden dark.'),
  // Epics (3)
  creature('star-wanderer', 'Wanderer', 8, 8, 8, 'epic', [], [], 'No constellation claims it; it crosses the heavens unbound, answering to no sky.'),
  ...
  creature('star-megastar', 'Megastar', 10, 10, 10, 'epic', [], [], 'A star grown beyond its sky, forged to burn where gods once trod.'),
  // Legendaries (2)
  creature('star-archon', 'Archon Stellara', 12, 12, 12, 'legendary', [], [], 'The Archon\'s will is the sky\'s own law; every star in her court burns to her design.'),
