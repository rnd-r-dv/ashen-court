...
const creature = (
	...
	attack,
	health,
	// Task 2: hand-authored Reflect (approved ledger 2026-08-10); the Task 1
	// transitional `reflect = attack` mirror is gone.
	reflect,
	keywords,
	effects: [],
	rarity,
...
export const NEUTRAL_CARDS: Card[] = [
	...
	spell(
		...
		2,
		"common",
		[{ kind: "buff", value: 1, value2: 1, value3: 1, target: "allFriendlyCreatures" }],
	...
	spell(
		...
		4,
		"rare",
		[{ kind: "dealDamage", value: 4, target: "enemyCreature" }],
	...
	spell(
		...
		5,
		"epic",
		[{ kind: "destroy", target: "enemyCreature" }],
	...
	spell(
		...
		4,
		"epic",
		[{ kind: "buff", value: 2, value2: 2, value3: 1, target: "friendlyCreature" }],
	...
	artifact(
		...
		6,
		"legendary",
		[{ when: "endOfTurn", effects: [{ kind: "copyCard" }] }],
