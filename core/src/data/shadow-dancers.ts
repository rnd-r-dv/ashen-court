...
export const CARDS: Card[] = [
  ...
  creature('dance-acrobat', 'Acrobat', 2, 2, 1, 2, 'common', ['stealth'], [], 'Gravity is a suggestion the Acrobat politely declines.'),
  spell('dance-slash', 'Slash', 2, 'common', [dmg(3, 'enemyCreature')], 'Quick, clean, and done before the scream finds its voice.'),
  creature('dance-dervish', 'Dervish', 2, 3, 1, 1, 'common', ['rush'], [], 'A whirlwind of blade and shadow — everywhere at once, and gone the moment the eye blinks.'),
  ...
  creature('dance-bladeweaver', 'Bladeweaver', 4, 4, 3, 4, 'common', ['stealth'], [], 'Threads of shadow, needles of steel — the battlefield is the loom, and blades are the thread.'),
  ...
  creature('dance-trickster', 'Trickster', 5, 4, 4, 4, 'rare', [], [{ when: 'battlecry', effects: [draw(1)] }], 'Watch the hands, not the eyes. Even the watchful leave poorer, unsure of what they lost.'),
  ...
  creature('dance-illusionist', 'Illusionist', 6, 5, 4, 5, 'rare', [], [{ when: 'battlecry', effects: [{ kind: 'returnToHand', target: 'enemyCreature' }] }], 'No light bends that the Illusionist cannot command, and no shadow that will not answer her call.'),
  // Epics (3)
  creature('dance-puppet', 'Puppet Master', 7, 6, 5, 6, 'epic', [], [{ when: 'battlecry', effects: [draw(2)] }], 'Strings unseen, audience unknowing — everyone dances to a tune only one can hear.'),
  ...
  creature('dance-shadow', 'Shadow Dancer', 7, 5, 4, 5, 'epic', [], [{ when: 'deathrattle', effects: [draw(2)] }], 'The dance does not end when the dancer falls; the shadows finish the steps.'),
  // Legendaries (2)
  creature('dance-nyx', 'Nyx, the Last Dance', 9, 8, 8, 8, 'legendary', ['windfury'], [], 'When Nyx Nightshade takes the floor, even fate holds its breath until she bows.'),
