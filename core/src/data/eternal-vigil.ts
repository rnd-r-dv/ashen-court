...
export const CARDS: Card[] = [
  // Commons (11)
  spell('vigil-bless', 'Bless', 1, 'common', [heal(2, 'any')]),
  creature('vigil-guard', 'Guard', 1, 1, 3, 'common'),
  spell('vigil-pray', 'Prayer', 2, 'common', [heal(4)]),
  creature('vigil-squire', 'Squire', 2, 2, 2, 'common'),
  spell('vigil-lights', 'Lights', 2, 'common', [dmg(1, 'allEnemies')]),
  creature('vigil-paladin', 'Paladin', 3, 2, 4, 'common', ['taunt']),
  spell('vigil-smite', 'Smite', 3, 'common', [dmg(3, 'enemyCreature')]),
  creature('vigil-monk', 'Monk', 3, 3, 3, 'common'),
  creature('vigil-shieldbearer', 'Shieldbearer', 4, 1, 6, 'common', ['taunt', 'shield']),
  spell('vigil-hymn', 'Hymn', 4, 'common', [heal(6)]),
  creature('vigil-crusader', 'Crusader', 5, 4, 5, 'common'),
  // Rares (5)
  spell('vigil-divine', 'Divine Shield', 2, 'rare', [giveK('shield', 'friendlyCreature')]),
  spell('vigil-layhands', 'Lay on Hands', 5, 'rare', [heal(8)]),
  creature('vigil-avenger', 'Avenger', 5, 5, 4, 'rare', ['rush']),
  creature('vigil-warden', 'Warden of Dawn', 6, 4, 6, 'rare', ['lifesteal']),
  spell('vigil-sanctify', 'Sanctify', 6, 'rare', [heal(10)]),
  // Epics (3)
  creature('vigil-archon', 'Archon of Dawn', 7, 6, 7, 'epic', ['taunt', 'lifesteal']),
  spell('vigil-radiance', 'Radiance', 7, 'epic', [heal(5), draw(2)]),
  creature('vigil-saint', 'Saint', 8, 5, 9, 'epic', ['lifesteal']),
  // Legendaries (2)
  creature('vigil-aldric', 'Ser Aldric', 9, 8, 8, 'legendary', ['taunt', 'lifesteal']),
  artifact('vigil-eternal', 'The Eternal Vigil', 6, 'legendary', [{ when: 'startOfTurn', effects: [heal(3)] }]),
];
