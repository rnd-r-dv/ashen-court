...
export const CARDS: Card[] = [
  ...
  creature('storm-adept', 'Adept', 2, 2, 2, 'common', ['rush'], [], 'Acolytes learn to read the sky long before they learn to break it.'),
  ...
  creature('storm-sorcerer', 'Sorcerer', 4, 3, 4, 'common', [], [{ when: 'battlecry', effects: [bounce('enemyCreature')] }], 'Every storm is a lesson, and the sorcerers take notes in lightning.'),
  ...
  creature('storm-stormcaller', 'Stormcaller', 6, 5, 5, 'rare', [], [{ when: 'battlecry', effects: [discSpell(2)] }], 'The clouds know their master\'s voice and come when called.'),
  creature('storm-leviathan', 'Leviathan', 7, 7, 7, 'rare', ['taunt'], [], 'Something vast moves beneath the storm-torn sea, and it is not the storm.'),
  ...
  creature('storm-thunderhead', 'Thunderhead', 9, 9, 9, 'epic', ['taunt'], [], 'A mountain of black cloud with a heartbeat of lightning.'),
  // Legendaries (2)
  creature('storm-zephyra', 'Zephyra', 10, 9, 9, 'legendary', ['windfury'], [], 'Where Zephyra walks, thunder follows at her heel, and the sky learns to strike twice.'),
